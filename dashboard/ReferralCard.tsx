...
export function ReferralCard() {
  ...
  return (
    <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-500/[0.05] via-white/[0.02] to-transparent p-6 shadow-xl">
        ...
        <div className="rounded-lg bg-white/[0.02] p-3">
          ...
          <div className="space-y-1.5 text-xs text-white/60">
            <div className="flex items-start gap-2">
              <span className="mt-0.5 h-4 w-4 shrink-0 rounded-full bg-emerald-500/20 text-center text-[9px] font-bold leading-4 text-emerald-300">1</span>
              <span>{t("step1")}</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-0.5 h-4 w-4 shrink-0 rounded-full bg-emerald-500/20 text-center text-[9px] font-bold leading-4 text-emerald-300">2</span>
              <span>{t("step2")}</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-0.5 h-4 w-4 shrink-0 rounded-full bg-emerald-500/20 text-center text-[9px] font-bold leading-4 text-emerald-300">3</span>
              <span>{t("step3")}</span>
            </div>
          </div>
        </div>
