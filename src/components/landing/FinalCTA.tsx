  ...
  return (
    <section className="relative py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <Card3DTilt glowColor="rgba(16, 185, 129, 0.3)">
            <div className="relative overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent p-8 text-center shadow-2xl shadow-emerald-500/10 sm:p-12 lg:p-16">
              {/* Background glow */}
