        ...
        <div className="relative">
          ...
          {drawInProgress && (
            <div className="mb-5 flex items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/5 p-3 text-xs text-amber-300">
              ...
              <span>{t("drawInProgressNote")}</span>
            </div>
          )}
          ...
          <div className="mb-6 grid grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-4">
              ...
              <div className="mt-1 text-[11px] text-white/40">
                {daysRemaining === 0
                  ? t("depositNeeded")
                  : t("daysUntilDeductionEnds")}
              </div>
            </div>
          </div>

          {/* Winner locked amount (if any) */}
          {userInfo.lockedAmount > 0n && (
            <div className="mb-5 flex items-center justify-between rounded-xl border border-amber-500/20 bg-amber-500/5 p-3 text-xs text-amber-200">
              <div className="flex items-center gap-2">
                <Lock className="h-4 w-4 text-amber-400" />
                <span>{t("lockedDripBalance")}</span>
              </div>
